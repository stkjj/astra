...
( function( $ ) {
	...
	wp.customize( 'astra-settings[button-radius]', function( setting ) {
		setting.bind( function( border ) {
			...
			var search_button_selector = wordpress_5_8_compat() ? ', form.wp-block-search .wp-block-search__inside-wrapper .wp-block-search__button' : '' ;
	...
	var search_button_selector = wordpress_5_8_compat() ? ', form.wp-block-search .wp-block-search__inside-wrapper .wp-block-search__button' : '' ;
	var search_button_hover_selector = wordpress_5_8_compat() ? ', form.wp-block-search .wp-block-search__inside-wrapper .wp-block-search__button:hover, form.wp-block-search .wp-block-search__inside-wrapper .wp-block-search__button:focus' : '' ;
