...
namespace {
     ...
     * @since 3.4.0
     */
    function astra_get_related_post_featured_image($current_post_id, $before = '', $after = '', $echo = \true)
    {
    }
    /**
